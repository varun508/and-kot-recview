...
fun TextView.setSleepDurationFormatted(night: SleepNight?) {
    night?.let { text = convertDurationToFormatted(it.startTimeMilli, it.endTimeMilli, context.resources) }
}

@BindingAdapter("sleepQualityString")
fun TextView.setSleepQualityString(night: SleepNight?) {
    night?.let { text = convertNumericQualityToString(it.sleepQuality, context.resources) }
}
